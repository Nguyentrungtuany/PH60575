  ...
  <main class="relative z-10 flex items-center justify-center min-h-screen">
    <div class="w-full max-w-5xl px-4">
      <div class="flex flex-col bg-white shadow-xl rounded-2xl">
        ...
        <!-- Form chỉnh sửa -->
        <form action="<?= BASE_URL_ADMIN . '?act=create-genres' ?>" method="POST" enctype="multipart/form-data">
              ...
              <table class="table-auto w-full text-slate-500 border-collapse">
                <tbody class="text-sm text-gray-700">
                  ...
                  <tr>
                    ...
                    <td class="px-6 py-3">
                        <input class=""  placeholder="Nhập tên danh mục"
                               name="name" value="<?= htmlspecialchars($anime['name'] ?? '') ?>" />
